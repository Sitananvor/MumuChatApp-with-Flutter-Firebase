...
import 'package:mumuchatapp/pages/auth/profile_page.dart';
import 'package:mumuchatapp/service/auth_service.dart';
import 'package:mumuchatapp/service/database_service.dart';
import 'package:mumuchatapp/widgets/group_tile.dart';
import 'package:mumuchatapp/widgets/widgets.dart';
import "package:mumuchatapp/pages/auth/search_page.dart";
...
String getName(String res) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: groupList(), //Main Content in Scaffold Page
  ...
  groupList() {
    // returns a StreamBuilder constructor that will be used to display real-time groups data retrieved from the Stream
    return StreamBuilder(
      stream: groups, // To track changes in data of group
      //Set the UI when the data in the Stream changes
